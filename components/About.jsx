        ...
        <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
            <div className='max-w-[1280px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    ...
                    <p className='py-2 text-gray-600'>I also learned that software development can feel overwhelming and impossible at times. When I encountered this, I listened to the advice from my Promineo Tech mentors and stepped away. More often than not I would come back, research my issue in a slightly different way, try something different, and voila! I'm looking forward to see where this journey leads.</p>
